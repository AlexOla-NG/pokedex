...
// TODO: stopped here
// refactor handleAddPokemon...rename to handleToggleTeam
  ...
  return (
    <>
      ...
      <Routes>
        <Route
          path="/"
          element={<Home handleAddPokemon={handleAddPokemon} />}
        />
        <Route
          path=":id"
          element={<PokemonDetails handleAddPokemon={handleAddPokemon} />}
        />
        <Route
          path="my-team"
          element={<MyTeam handleAddPokemon={handleAddPokemon} />}
        />
